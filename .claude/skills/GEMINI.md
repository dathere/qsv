...
- **Tool Definition System (`src/mcp-tools.ts`):** Dynamically generates tool definitions for 56 `qsv` commands. It includes a "Guidance Enhancement" system providing `USE WHEN`, `COMMON PATTERNS`, and `CAUTION` hints to help agents make optimal tool choices.
