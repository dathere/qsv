...
1. Use qsv commands to explore and pre-aggregate the data:
...
2. Embed the aggregated results as JSON within the HTML file
...
// DO: pre-aggregate with qsv sqlp before embedding
const CHART_DATA = {
    monthly_revenue: [
