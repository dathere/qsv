...
The extension uses **qsvmcp**, a streamlined variant of qsv purpose-built for MCP server use. It ships with 69 commands (vs 79 in the full qsv binary), plus built-in session logging for increased reproducibility.
