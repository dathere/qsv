# macOS Setup — qsv MCP Server + Cowork Plugin

This guide walks you through installing the qsv MCP Server and the optional Cowork Plugin on macOS.
...
The qsv plugin is distributed through a plugin marketplace hosted in the qsv GitHub repository. Open **Terminal** and run:
