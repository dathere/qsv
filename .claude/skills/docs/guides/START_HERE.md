...
|-----------|-----------|-----------------|
| `.mcpb` (MCP Server) | The qsv tools Claude can call in Chat + Cowork | 60 data-wrangling commands (via qsvmcp), SQL queries, file conversion. **Auto-installs the qsv binary** — no separate download needed. |
