...
Use **`mcp__qsv__qsv_search_tools`** to discover commands beyond the initially loaded core tools. There are 56 qsv skill-based commands covering selection, filtering, transformation, aggregation, joining, validation, formatting, conversion, and more.
