...
- Root directory: `/`
- Commands in `src/cmd/`
- Binary variants and command counts (per MEMORY.md):
...
- MCP server exposing 55 qsv commands as skill JSONs to AI agents
...
- `.claude/skills/src/` — TypeScript MCP server source (~29 files)
