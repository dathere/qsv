...
~230 commits since 22.0.1, and the theme is **context** - the surrounding facts that turn a number into a finding. A count of 4,312 says nothing; 4,312 *per 100,000 residents* says where to look.
...
**Full Changelog**: https://github.com/dathere/qsv/compare/22.0.1...23.0.0
