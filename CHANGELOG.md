...
3. **`geocode` goes online with OpenCage.** Geospatially contextualize and normalize your location data with [OpenCage](https://opencagedata.com/). Unlike other geocoders - OpenCage is built from open data; allows indefinite caching; and is often much cheaper.
