...
[![Minimum supported Rust version](https://img.shields.io/badge/Rust-1.92-red?logo=rust)](#minimum-supported-rust-version)
...
| [moarstats](/src/cmd/moarstats.rs)<br>📇🏎️ | Add additional stats and outlier metadata to an existing stats CSV file. |
...
🐻‍❄️: command powered/accelerated by [![polars 0.52.0 at py-1.36.1 tag, b5956c3 revision](https://img.shields.io/badge/polars-0.52.0%20at%20py1.36.1:b5956c3-blue?logo=polars
...
It has an extensive test suite with ~2,380 tests, including several [property tests](https://medium.com/criteo-engineering/introduction-to-property-based-testing-f5236229d237) which [randomly generate](https://github.com/BurntSushi/quickcheck#quickcheck) parameters for oft-used commands.   
...
## Testing
qsv has ~2,380 tests in the [tests](https://github.com/dathere/qsv/tree/master/tests) directory.
