...
| [frequency](/src/cmd/frequency.rs#L2)<br>📇😣🏎️👆🪄 | Build [frequency distribution tables](https://en.wikipedia.org/wiki/Frequency_(statistics)) of each column. Uses multithreading to go faster if an index is present (Examples: [CSV](https://github.com/dathere/qsv/blob/master/scripts/NYC_311_SR_2010-2020-sample-1M-frequency.csv) [JSON](https://github.com/dathere/qsv/blob/master/scripts/NYC_311_SR_2010-2020-sample-1M-frequency.json)). |
...
🐻‍❄️: command powered/accelerated by [![polars 0.51.0 at the py-1.35.0 tag](https://img.shields.io/badge/polars-0.51.0-blue) at the py-1.35.0 tag](https://github.com/pola-rs/polars/releases/tag/py-1.35.0) vectorized query engine.  
