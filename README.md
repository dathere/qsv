...
| [describegpt](/src/cmd/describegpt.rs#L2)<br>🌐🤖🪄 | Infer a Data Dictionary, Description & Tags or ask questions about a CSV using any [OpenAI API](https://platform.openai.com/docs/introduction)-compatible LLM, including local LLMs like [Ollama](https://ollama.com), [Jan](https://jan.ai) and [LM Studio](https://lmstudio.ai/). |
