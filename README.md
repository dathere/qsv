...
🐻‍❄️: command powered/accelerated by [![polars 0.54.4:py-1.42.0](https://img.shields.io/badge/polars-0.54.4:py_1.42.0-blue?logo=polars)](https://github.com/pola-rs/polars/releases/tag/py-1.42.0) vectorized query engine.  
