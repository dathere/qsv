...
[![Minimum supported Rust version](https://img.shields.io/badge/Rust-1.91-red?logo=rust)](#minimum-supported-rust-version)
...
| [describegpt](/src/cmd/describegpt.rs#L2)<br>🌐🤖🪄🗃️📚 ![CKAN](docs/images/ckan.png) | <a name="describegpt_deeplink"></a>Infer a "neuro-procedural" (not quite ["neuro-symbolic"](https://en.wikipedia.org/wiki/Neuro-symbolic_AI)) Data Dictionary, Description & Tags or ask questions about a CSV with a [configurable prompt file](resources/describegpt_defaults.toml), using any [OpenAI API](https://platform.openai.com/docs/introduction)-compatible LLM, including local LLMs like [Ollama](https://ollama.com), [Jan](https://jan.ai) & [LM Studio](https://lmstudio.ai/).<br>(e.g. `--all` [Markdown](docs/nyc311-describegpt.md), [JSON](docs/nyc311-describegpt.json); [--prompt "What are the top 10 complaint types by community board & borough by year?"](docs/nyc311-describegpt-prompt.md), [deterministic, hallucination-free SQL RAG result](docs/nyc311-describegpt-prompt.csv)) |
...
| [frequency](/src/cmd/frequency.rs#L2)<br>📇😣🏎️👆🪄 | Build [frequency distribution tables](https://en.wikipedia.org/wiki/Frequency_(statistics)) of each column. Uses multithreading to go faster if an index is present (Examples: [CSV](https://github.com/dathere/qsv/blob/master/scripts/boston311-100.freqs.csv) [JSON](https://github.com/dathere/qsv/blob/master/scripts/boston311-100.freqs.json)). |
...
🐻‍❄️: command powered/accelerated by [![polars 0.52.0 at py-1.36.0 tag](https://img.shields.io/badge/polars-0.52.0%40py-1.36.0_tag?style=flat&logo=polars&color=blue
)](https://github.com/pola-rs/polars/releases/tag/py-1.36.0) vectorized query engine.  
