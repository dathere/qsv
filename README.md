...
| [describegpt](/src/cmd/describegpt.rs#L2)<br>🌐🤖🪄 | Infer extended metadata about a CSV using a GPT model from [OpenAI's API](https://platform.openai.com/docs/introduction) or any other OpenAI compatible LLM like [Ollama](https://ollama.com), [Jan](https://jan.ai) or [LM Studio](https://lmstudio.ai/). |
