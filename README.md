...
![Luau](docs/images/luau.png) : uses [Luau](https://luau.org/) [0.723](https://github.com/Roblox/luau/releases/tag/0.723) as an embedded scripting [DSL](https://en.wikipedia.org/wiki/Domain-specific_language).  
...
It has an extensive test suite with more than 2,950 tests, including several [property tests](https://medium.com/criteo-engineering/introduction-to-property-based-testing-f5236229d237) which [randomly generate](https://github.com/BurntSushi/quickcheck#quickcheck) parameters for oft-used commands.   
...
## Testing
qsv has 3,094 tests (2,865 integration + 229 unit) in the [tests](https://github.com/dathere/qsv/tree/master/tests) directory and across `src/` modules.
