...
🐻‍❄️: command powered/accelerated by [![polars 0.51.0](https://img.shields.io/badge/polars-0.51.0-blue)](https://github.com/pola-rs/polars/releases/tag/0.51.0) vectorized query engine.  
