...
| [profile](docs/help/profile.md)✨<br>📇🧠🤖📚⛩️ ![CKAN](docs/images/ckan.png) | Extract, derive & infer metadata from a CSV or a CKAN dataset/resource - using the statistical profile of a dataset, mapped and driven by a metadata [scheming](https://github.com/ckan/ckanext-scheming) YAML spec. This enables [FAIRification](https://www.go-fair.org/fair-principles/fairification-process/) at scale. |
