...
🐻‍❄️: command powered/accelerated by [![polars 0.55.2 at py-1.44.0](https://img.shields.io/badge/polars-0.55.2:py1.44.0-blue?logo=polars)](https://github.com/pola-rs/polars/releases/tag/py-1.44.0) vectorized query engine.  
