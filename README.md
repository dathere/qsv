...
🐻‍❄️: command powered/accelerated by [![polars 0.54.4:py-1.43.2](https://img.shields.io/badge/polars-0.54.4:py_1.43.2-blue?logo=polars)](https://github.com/pola-rs/polars/releases/tag/py-1.43.2) vectorized query engine.  
