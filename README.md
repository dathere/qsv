...
🐻‍❄️: command powered/accelerated by [![polars 0.52.0 at py-1.37.1:9f9dee8](https://img.shields.io/badge/polars-0.52.0%20at%20py1.37.1:9f9dee8-blue?logo=polars
...
It has an extensive test suite with ~2,425 tests, including several [property tests](https://medium.com/criteo-engineering/introduction-to-property-based-testing-f5236229d237) which [randomly generate](https://github.com/BurntSushi/quickcheck#quickcheck) parameters for oft-used commands.   
...
## Testing
qsv has ~2,425 tests in the [tests](https://github.com/dathere/qsv/tree/master/tests) directory.
