...
🐻‍❄️: command powered/accelerated by [![polars 0.51.0 at the py-1.35.0 tag](https://img.shields.io/badge/polars-0.51.0-blue) at the py-1.35.0:ce396f4 tag](https://github.com/pola-rs/polars/releases/tag/py-1.35.0) vectorized query engine.  
