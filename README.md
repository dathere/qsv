...
🐻‍❄️: command powered/accelerated by [![polars 0.50.0 at the py-1.33.0 tag](https://img.shields.io/badge/polars-0.50.0-blue)](https://github.com/pola-rs/polars/releases/tag/py-1.33.0) vectorized query engine.  
