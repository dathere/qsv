...
Register-ArgumentCompleter -Native -CommandName 'qsv' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'qsv' {
            ...
            [CompletionResult]::new('blake3', 'blake3', [CompletionResultType]::ParameterValue, 'blake3')
            ...
            [CompletionResult]::new('scoresql', 'scoresql', [CompletionResultType]::ParameterValue, 'scoresql')
        ...
        'qsv;apply' {
            ...
            [CompletionResult]::new('--on-error', '--on-error', [CompletionResultType]::ParameterName, 'on-error')
            ...
            [CompletionResult]::new('summarize', 'summarize', [CompletionResultType]::ParameterValue, 'summarize')
            [CompletionResult]::new('help', 'help', [CompletionResultType]::ParameterValue, 'Print this message or the help of the given subcommand(s)')
            break
        }
        'qsv;apply;calcconv' {
        ...
        'qsv;blake3' {
            [CompletionResult]::new('--derive-key', '--derive-key', [CompletionResultType]::ParameterName, 'derive-key')
            [CompletionResult]::new('-j', '-j', [CompletionResultType]::ParameterName, 'j')
            [CompletionResult]::new('--jobs', '--jobs', [CompletionResultType]::ParameterName, 'jobs')
            ...
            [CompletionResult]::new('--keyed', '--keyed', [CompletionResultType]::ParameterName, 'keyed')
            [CompletionResult]::new('--no-mmap', '--no-mmap', [CompletionResultType]::ParameterName, 'no-mmap')
            [CompletionResult]::new('--no-names', '--no-names', [CompletionResultType]::ParameterName, 'no-names')
        ...
        'qsv;describegpt' {
            ...
            [CompletionResult]::new('--context-file', '--context-file', [CompletionResultType]::ParameterName, 'context-file')
            ...
            [CompletionResult]::new('--markdown-template', '--markdown-template', [CompletionResultType]::ParameterName, 'markdown-template')
            [CompletionResult]::new('-t', '-t', [CompletionResultType]::ParameterName, 't')
            [CompletionResult]::new('--max-tokens', '--max-tokens', [CompletionResultType]::ParameterName, 'max-tokens')
            [CompletionResult]::new('-m', '-m', [CompletionResultType]::ParameterName, 'm')
            [CompletionResult]::new('--model', '--model', [CompletionResultType]::ParameterName, 'model')
            ...
            [CompletionResult]::new('--score-max-retries', '--score-max-retries', [CompletionResultType]::ParameterName, 'score-max-retries')
            [CompletionResult]::new('--score-threshold', '--score-threshold', [CompletionResultType]::ParameterName, 'score-threshold')
            ...
            [CompletionResult]::new('--no-cache', '--no-cache', [CompletionResultType]::ParameterName, 'no-cache')
            [CompletionResult]::new('--no-score-sql', '--no-score-sql', [CompletionResultType]::ParameterName, 'no-score-sql')
            [CompletionResult]::new('--prepare-context', '--prepare-context', [CompletionResultType]::ParameterName, 'prepare-context')
            [CompletionResult]::new('--process-response', '--process-response', [CompletionResultType]::ParameterName, 'process-response')
            [CompletionResult]::new('-q', '-q', [CompletionResultType]::ParameterName, 'q')
            [CompletionResult]::new('--quiet', '--quiet', [CompletionResultType]::ParameterName, 'quiet')
        ...
        'qsv;diff' {
            ...
            [CompletionResult]::new('--drop-equal-columns', '--drop-equal-columns', [CompletionResultType]::ParameterName, 'drop-equal-columns')
        ...
        'qsv;frequency' {
            ...
            [CompletionResult]::new('-s', '-s', [CompletionResultType]::ParameterName, 's')
            [CompletionResult]::new('--select', '--select', [CompletionResultType]::ParameterName, 'select')
            [CompletionResult]::new('--sketch-map-size', '--sketch-map-size', [CompletionResultType]::ParameterName, 'sketch-map-size')
            [CompletionResult]::new('--sketch-method', '--sketch-method', [CompletionResultType]::ParameterName, 'sketch-method')
        ...
        'qsv;headers' {
            ...
            [CompletionResult]::new('--trim', '--trim', [CompletionResultType]::ParameterName, 'trim')
            [CompletionResult]::new('--union', '--union', [CompletionResultType]::ParameterName, 'union')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        }
        'qsv;implode' {
            ...
            [CompletionResult]::new('--rename', '--rename', [CompletionResultType]::ParameterName, 'rename')
            [CompletionResult]::new('-v', '-v', [CompletionResultType]::ParameterName, 'v')
            [CompletionResult]::new('--value', '--value', [CompletionResultType]::ParameterName, 'value')
            [CompletionResult]::new('-n', '-n', [CompletionResultType]::ParameterName, 'n')
            [CompletionResult]::new('--no-headers', '--no-headers', [CompletionResultType]::ParameterName, 'no-headers')
            [CompletionResult]::new('--skip-empty', '--skip-empty', [CompletionResultType]::ParameterName, 'skip-empty')
            [CompletionResult]::new('--sorted', '--sorted', [CompletionResultType]::ParameterName, 'sorted')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        ...
        'qsv;pivotp' {
            ...
            [CompletionResult]::new('--decimal-comma', '--decimal-comma', [CompletionResultType]::ParameterName, 'decimal-comma')
            [CompletionResult]::new('--grand-total', '--grand-total', [CompletionResultType]::ParameterName, 'grand-total')
            [CompletionResult]::new('--ignore-errors', '--ignore-errors', [CompletionResultType]::ParameterName, 'ignore-errors')
            [CompletionResult]::new('--maintain-order', '--maintain-order', [CompletionResultType]::ParameterName, 'maintain-order')
            [CompletionResult]::new('-q', '-q', [CompletionResultType]::ParameterName, 'q')
            [CompletionResult]::new('--quiet', '--quiet', [CompletionResultType]::ParameterName, 'quiet')
            [CompletionResult]::new('--sort-columns', '--sort-columns', [CompletionResultType]::ParameterName, 'sort-columns')
            [CompletionResult]::new('--subtotal', '--subtotal', [CompletionResultType]::ParameterName, 'subtotal')
            [CompletionResult]::new('--try-parsedates', '--try-parsedates', [CompletionResultType]::ParameterName, 'try-parsedates')
            [CompletionResult]::new('--validate', '--validate', [CompletionResultType]::ParameterName, 'validate')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
        ...
        'qsv;pragmastat' {
            [CompletionResult]::new('--compare1', '--compare1', [CompletionResultType]::ParameterName, 'compare1')
            [CompletionResult]::new('--compare2', '--compare2', [CompletionResultType]::ParameterName, 'compare2')
            [CompletionResult]::new('-d', '-d', [CompletionResultType]::ParameterName, 'd')
            [CompletionResult]::new('--delimiter', '--delimiter', [CompletionResultType]::ParameterName, 'delimiter')
            [CompletionResult]::new('-j', '-j', [CompletionResultType]::ParameterName, 'j')
            [CompletionResult]::new('--jobs', '--jobs', [CompletionResultType]::ParameterName, 'jobs')
            ...
            [CompletionResult]::new('--select', '--select', [CompletionResultType]::ParameterName, 'select')
            [CompletionResult]::new('--stats-options', '--stats-options', [CompletionResultType]::ParameterName, 'stats-options')
            [CompletionResult]::new('--subsample', '--subsample', [CompletionResultType]::ParameterName, 'subsample')
            [CompletionResult]::new('--force', '--force', [CompletionResultType]::ParameterName, 'force')
            [CompletionResult]::new('--memcheck', '--memcheck', [CompletionResultType]::ParameterName, 'memcheck')
            [CompletionResult]::new('--no-bounds', '--no-bounds', [CompletionResultType]::ParameterName, 'no-bounds')
            [CompletionResult]::new('-n', '-n', [CompletionResultType]::ParameterName, 'n')
            [CompletionResult]::new('--no-headers', '--no-headers', [CompletionResultType]::ParameterName, 'no-headers')
            [CompletionResult]::new('--standalone', '--standalone', [CompletionResultType]::ParameterName, 'standalone')
            [CompletionResult]::new('-t', '-t', [CompletionResultType]::ParameterName, 't')
        ...
        'qsv;safenames' {
            ...
            [CompletionResult]::new('--collapse', '--collapse', [CompletionResultType]::ParameterName, 'collapse')
            [CompletionResult]::new('--unicode', '--unicode', [CompletionResultType]::ParameterName, 'unicode')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        ...
        'qsv;scoresql' {
            ...
            [CompletionResult]::new('-o', '-o', [CompletionResultType]::ParameterName, 'o')
            [CompletionResult]::new('--output', '--output', [CompletionResultType]::ParameterName, 'output')
            [CompletionResult]::new('--duckdb', '--duckdb', [CompletionResultType]::ParameterName, 'duckdb')
            [CompletionResult]::new('--ignore-errors', '--ignore-errors', [CompletionResultType]::ParameterName, 'ignore-errors')
            [CompletionResult]::new('--json', '--json', [CompletionResultType]::ParameterName, 'json')
            [CompletionResult]::new('-q', '-q', [CompletionResultType]::ParameterName, 'q')
            [CompletionResult]::new('--quiet', '--quiet', [CompletionResultType]::ParameterName, 'quiet')
        ...
        'qsv;stats' {
            ...
            [CompletionResult]::new('--cardinality-method', '--cardinality-method', [CompletionResultType]::ParameterName, 'cardinality-method')
            [CompletionResult]::new('--dates-whitelist', '--dates-whitelist', [CompletionResultType]::ParameterName, 'dates-whitelist')
            [CompletionResult]::new('-d', '-d', [CompletionResultType]::ParameterName, 'd')
            [CompletionResult]::new('--delimiter', '--delimiter', [CompletionResultType]::ParameterName, 'delimiter')
            [CompletionResult]::new('-j', '-j', [CompletionResultType]::ParameterName, 'j')
            [CompletionResult]::new('--jobs', '--jobs', [CompletionResultType]::ParameterName, 'jobs')
            [CompletionResult]::new('--mode-cardinality-cap', '--mode-cardinality-cap', [CompletionResultType]::ParameterName, 'mode-cardinality-cap')
            [CompletionResult]::new('-o', '-o', [CompletionResultType]::ParameterName, 'o')
            [CompletionResult]::new('--output', '--output', [CompletionResultType]::ParameterName, 'output')
            [CompletionResult]::new('--percentile-list', '--percentile-list', [CompletionResultType]::ParameterName, 'percentile-list')
            [CompletionResult]::new('--quantile-method', '--quantile-method', [CompletionResultType]::ParameterName, 'quantile-method')
            [CompletionResult]::new('--round', '--round', [CompletionResultType]::ParameterName, 'round')
            [CompletionResult]::new('-s', '-s', [CompletionResultType]::ParameterName, 's')
            [CompletionResult]::new('--select', '--select', [CompletionResultType]::ParameterName, 'select')
            [CompletionResult]::new('--weight', '--weight', [CompletionResultType]::ParameterName, 'weight')
        ...
        'qsv;to' {
            ...
            [CompletionResult]::new('-a', '-a', [CompletionResultType]::ParameterName, 'a')
            [CompletionResult]::new('--stats', '--stats', [CompletionResultType]::ParameterName, 'stats')
            [CompletionResult]::new('--try-parse-dates', '--try-parse-dates', [CompletionResultType]::ParameterName, 'try-parse-dates')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
