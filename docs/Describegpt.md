...
`first_name`, `last_name`, `full_name`, `username`, `password`, `email`, `phone`, `street_address`, `building_number`, `secondary_address`, `city`, `state`, `state_abbr`, `zip_code`, `country`, `country_code`, `latitude`, `longitude`, `time_zone`, `company_name`, `job_title`, `uuid`, `credit_card`, `currency_code`, `money`, `isbn`, `ip_address`, `mac_address`, `url`, `user_agent`, `file_name`, `file_path`, `mime_type`, `color_hex`, `time`, `category`, `lorem_word`, `lorem_sentence`, `lorem_paragraph`, `free_text`, `street_name`, `industry`, `profession`, `unique_id`, `ipv6_address`, `license_plate`, `date`, `datetime`, `duration`, `unknown`
