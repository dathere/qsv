...
| `QSV_PREFER_DMY` | if set, date parsing will use DMY format. Otherwise, use MDY format (used with `datefmt`, `frequency`, `joinp`, `moarstats`, `pivotp`, `sample`, `schema`, `sniff`, `stats`, `tojsonl` & `viz` commands). |
