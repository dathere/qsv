...
[Luau 0.690](https://github.com/Roblox/luau/releases/tag/0.690) is currently embedded - qsv's policy is to use the latest stable Luau version at the time of each qsv release.
