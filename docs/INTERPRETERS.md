...
[Luau 0.688](https://github.com/Roblox/luau/releases/tag/0.688) is currently embedded - qsv's policy is to use the latest stable Luau version at the time of each qsv release.
