...
It also allows mapping of multiple new computed columns, supports random access with indexed CSV files, and has [several helper functions](https://github.com/dathere/qsv/wiki/Scripting-Luau-Python#helper-functions) to help ease the development of [full-fledged data-wrangling scripts](https://github.com/dathere/qsv/wiki/Scripting-Luau-Python#luau).
...
You can override this by setting `PYO3_PYTHON` (e.g., `PYO3_PYTHON=python3.11`), before installing/compiling qsv. See the [PyO3 User Guide](https://pyo3.rs/latest/building-and-distribution.html) for more information.
