...
Shows that I'm running qsv version 2.0.0, with the `mimalloc` allocator (instead of `standard`), and I have:
...
* compiled with the last known Rust nightly/unstable that passes all ~1,919 tests.
