...
```bash
$ qsv --version
qsv 21.1.0-jemalloc-apply;fetch;foreach;geocode;Luau 0.736;magika;to;polars-0.54.4:py-1.40.1:1e9a63b;self_update-16-16;51.20 GiB-0 B-47.73 GiB-64.00 GiB (aarch64-apple-darwin compiled with Rust 1.96;macOS 26.5-Darwin 25.5.0;Apple M4 Max-16) prebuilt
```
...
- the exact version of the embedded Luau interpreter (Luau 0.736),
