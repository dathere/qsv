...
- Language: Rust (edition 2024; minimum Rust 1.96)
...
- `qsvmcp` (MCP server optimized): built with `qsvmcp` feature (geocode, get, get_cloud, mcp, polars, profile, self_update, synthesize, to, viz_static); shares `main.rs` with `qsv`
