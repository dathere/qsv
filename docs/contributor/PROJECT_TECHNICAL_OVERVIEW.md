...
- Language: Rust (edition 2024; minimum Rust 1.95)
...
- `qsvmcp` (MCP server optimized): built with `qsvmcp` feature (geocode, luau, mcp, polars, self_update, synthesize, to); shares `main.rs` with `qsv`
