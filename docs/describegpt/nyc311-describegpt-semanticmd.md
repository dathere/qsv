...
- **Missing values & sparsity** – Closed Date, Resolution Description, Due Date, Latitude, Longitude, and many address components each miss ≈25–65 % of records; the dataset’s overall sparsity is moderate (~0.3 when considering all fields).  
