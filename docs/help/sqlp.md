...
**[Table of Contents](TableOfContents.md)** | **Source: [src/cmd/sqlp.rs](https://github.com/dathere/qsv/blob/master/src/cmd/sqlp.rs)** | <abbr title="uses an index when available.">📇</abbr><abbr title="multithreaded even without an index.">🚀</abbr><abbr title="command powered/accelerated by  vectorized query engine.">🐻‍❄️</abbr><abbr title="Extended input support.">🗄️</abbr><abbr title="&quot;automagical&quot; commands that uses stats and/or frequency tables to work &quot;smarter&quot; & &quot;faster&quot;.">🪄</abbr>
