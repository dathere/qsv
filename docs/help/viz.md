...
| &nbsp;`‑‑language`&nbsp; | string | Render the dashboard UI in this language. Accepts a BCP-47/ISO 639 code (es, spa) or an English language name (Spanish). Overrides the language detected in a data dictionary, and is also forwarded to describegpt when inferring one. Curated: en, es, fr, de, it, pt-BR. | `auto` |
