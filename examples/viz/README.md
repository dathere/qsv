...
Note that `raw.githubusercontent.com` serves HTML as `text/plain`, so a browser
shows the source rather than rendering it. To view the charts, open the raw URL
through the htmlpreview wrapper:

<https://htmlpreview.github.io/?https://raw.githubusercontent.com/dathere/qsv/master/examples/viz/gallery.html>
