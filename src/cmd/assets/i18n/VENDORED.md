...
The same held again on **2026-09-24**, when the pin moved from `dt-3.0.4/b-4.0.3/cc-2.0.2/date-2.0.0/sb-2.0.1`
to `dt-3.1.1/b-4.1.1/cc-2.1.1/date-2.1.1/sb-2.1.0`: all seven files were sha256-compared against
`https://cdn.datatables.net/plug-ins/3.1.1/i18n/<code>.json` and every one was **byte-identical**
once more. This was a packaging-focused upstream release (ESM `exports`, windowless evaluation);
the `zh` SearchBuilder date-condition inversion is *still* unfixed at 3.1.1, so the splice-time
