...
/// Parse the --language option to determine if it's autodetect, a numeric threshold, or an explicit
/// language Returns (is_autodetect, threshold, explicit_language)
